...
const WHAT: Record<MotorTask, string[]> = {
  RIGHT_HAND: [
    ...
    "La señal C3 presenta reducción simulada de potencia Mu/Beta.",
  ...
  LEFT_HAND: [
    ...
    "La señal C4 presenta mayor desincronización simulada.",
  ...
  RIGHT_ARM: [
    ...
    "C3 baja, pero menos que en la mano.",
  ...
  LEFT_ARM: [
    ...
    "El ERD es más suave que el de la mano.",
  ...
  FEET: [
    ...
    "La zona medial / Cz concentra el cambio simulado.",
  ...
  TONGUE: [
    ...
    "La desincronización es más bilateral y anterior (F3/Fz).",
